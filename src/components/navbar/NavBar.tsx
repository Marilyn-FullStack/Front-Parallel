      ...
      <Box p='4'>
        <ul className="list-style-none mr-auto flex lg:flex-row" data-te-navbar-nav-ref>
          <li className="mb-4 mx-5 lg:mb-0 lg:pr-2" data-te-nav-item-ref>
            <Link to="/home" className="flex px-4 py-2 items-center justify-center font-semibold rounded-3xl transition-colors duration-300 hover:text-white hover:bg-[#a67f78]">
              Página Inicial
            </Link>
          </li>
              ...
              {({ isOpen }) => (
                <>
                  ...
                  <MenuList fontSize={15}>
                    ...
                    <MenuItem bg="#f7fafc" color={'#32435f'} _hover={{ bg: 'none', color: '#a2a182' }}>
                      <Link to="/editarCategoria/1">Editar Categoria</Link>
                    </MenuItem>
                    <MenuItem bg="#f7fafc" color={'#32435f'} _hover={{ bg: 'none', color: '#a2a182' }}>
                      <Link to="/categorias">Listar Categorias</Link>
                    </MenuItem>
                    <MenuItem bg="#f7fafc" color={'#32435f'} _hover={{ bg: 'none', color: '#a2a182' }}>
                      <Link to="/deletarCategoria/1">Deletar Categoria</Link>
                    </MenuItem>
                  </MenuList>
                </>
              )}
